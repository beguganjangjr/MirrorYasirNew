...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg = f"/{BotCommands.WatchCommand} [yt_dl supported link] [quality] |[CustomName] untuk mirror dengan youtube_dl.\n\n"
        msg += "<b>Catatan :- Kualitas dan custom nama adalah opsional.</b>\n\nContoh kualitas :- audio, 144, 240, 360, 480, 720, 1080, 2160."
        msg += "\n\nJika kamu ingin menggunakan custom nama, tambahkan setelah tanda |"
        msg += f"\n\Contoh :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/ocX2FN1nguA 720 |Iki videoku gaesss</code>\n\n"
        msg += "File ini akan di download di kualitas 720p dan namanya akan menjadi <b>Iki videoku gaesss</b>"
